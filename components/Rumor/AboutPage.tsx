    ...
    <div className='flex w-full justify-center' {...storyblokEditable(blok)}>
      <div className='flex w-11/12 flex-col items-center'>
        <div className='flex w-full justify-center'>
          <img
            className='relative  top-[-8rem] max-h-[29rem] w-11/12 object-cover sm:top-[-11rem]  md:-top-[13rem] lg:top-[-15rem] xl:top-[-16rem]'
            src={image.filename}
            alt='img'
          />
        </div>
        <div className=' mt-[-7rem] w-11/12 sm:w-8/12 sm:pt-1 xl:mt-[-13rem]'>
